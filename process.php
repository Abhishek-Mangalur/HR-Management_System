<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if (mysqli_num_rows($result) > 0){
            ...
            $sql="INSERT INTO empdetails(empid, password, name, addr, email, dept, age, dob, mob, desig, bank, ac, salary, gender, edu) VALUES('$empid', '$password', '$name', '$addr', '$email', '$dept', '$age', '$dob', '$mob', '$desig', '$bank', '$ac', '$salary', '$gender', '$chk')";
